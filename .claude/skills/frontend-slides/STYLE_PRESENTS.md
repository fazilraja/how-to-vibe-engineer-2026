...
### 13. Hacklahoma Retro Map

**Vibe:** Retro, vintage, earthy, outdoorsy, hackathon

**Layout:** Centered content on beige/cream. Topographic map textures. Vintage postcard feel with subtle rotations and drop shadows.

**Typography:**
- Display: `Source Serif 4` (400/700) — classic serif
- Body: `Source Code Pro` (400/700) — monospace
...
:root {
    --bg-cream: #FFFCF5;
    --bg-beige: #F5F5DC;
    --bg-light-beige: #e8e8c7;
    --text-primary: #3D472C;      /* Dark olive */
    --text-secondary: #575f49;    /* Medium olive */
    --text-emphasis: #2a3a1f;     /* Dark forest green */
    --accent: #575f49;            /* Olive borders/lines */
}
```

**Signature Elements:**
- Muted earth tones (olive greens, beige, cream)
- Subtle rotation transforms on cards/images (`rotate(-1deg)`, `rotate(2deg)`)
- Drop shadows on images for vintage postcard depth
- Cream overlay at 15% opacity for faded/aged look
- Decorative pine tree or nature icons
- **No illustrations—only geometric CSS shapes and textures**
...
| Hacklahoma Retro Map | Source Serif 4 | Source Code Pro | Google |
